...
class TestFYM(unittest.TestCase):
    ...
    def test_Smoke__As_a_teacher_I_can_login_in_the_application__uid9059fd48d38747f4bc60d075fd948042(self):
        self.smoke__as_a_teacher_i_can_login_in_the_application(username = 'teacher.calculus@testschool.org', password = 'password', subject = 'AP Calculus AB')

    def test_Smoke__As_a_teacher_I_can_login_in_the_application__uid81cd450f4c534fc4981d2534d19c871f(self):
        self.smoke__as_a_teacher_i_can_login_in_the_application(username = 'teacher.apbiology@testschool.org', password = 'password', subject = 'AP Biology')
